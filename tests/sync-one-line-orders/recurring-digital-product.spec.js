...
const productSku = '1-recurring-digital';
...
describe(testSuites.syncOneLineOrders, async () => {
	it(`${testSuites.syncOneLineOrders} | Recurring digital product`, async () => {
		logger.stepNumber(1);
		logger.step('Place order');
		await OrderFormPageHelper.placeRecurringDigitalProductOrder(orderUrl);
